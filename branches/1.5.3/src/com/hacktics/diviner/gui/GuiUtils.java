...
public class GuiUtils {
	...
	private static String IMAGE_QUESTION = "/com/hacktics/diviner/gui/resource/divinerIcons/About-48x48.png";
	private static final String IMAGE_SESSION = "/com/hacktics/diviner/gui/resource/divinerIcons/Cookie-16x16.PNG";
	private static final String IMAGE_OUTPUT = "/com/hacktics/diviner/gui/resource/divinerIcons/Output3-16x16.png";
	private static final String IMAGE_DB = "/com/hacktics/diviner/gui/resource/divinerIcons/dB3-16x16.png";
	private static final String IMAGE_LOGO = "/com/hacktics/diviner/gui/resource/divinerIcons/hacktics_logo.jpg";
	private static final String IMAGE_POST = "/com/hacktics/diviner/gui/resource/divinerIcons/Post-48x48.png";
	private static final String IMAGE_GET = "/com/hacktics/diviner/gui/resource/divinerIcons/Get-48x48.png";
	private static final String IMAGE_LOGO_ICON = "/com/hacktics/diviner/gui/resource/divinerIcons/hacktics_icon.JPG";
	private static final String IMAGE_MAGNIFY_DISABLED = "/com/hacktics/diviner/gui/resource/divinerIcons/magnify24.png";
	private static final String IMAGE_MAGNIFY_ENABLED = "/com/hacktics/diviner/gui/resource/divinerIcons/magnifyEnabled24.png";
	private static final String IMAGE_EYE = "/com/hacktics/diviner/gui/resource/divinerIcons/eye-blue24.png";
	private static final String IMAGE_STAR = "/com/hacktics/diviner/gui/resource/divinerIcons/star24.png";
	private static final String IMAGE_AUTHENTICATED = "/com/hacktics/diviner/gui/resource/divinerIcons/lock.png";
	private static final String IMAGE_UNAUTHENTICATED = "/com/hacktics/diviner/gui/resource/divinerIcons/door.png";
	private static final String IMAGE_REPEATER = "/com/hacktics/diviner/gui/resource/divinerIcons/injection.png";
	private static final String IMAGE_RIGHT = "/com/hacktics/diviner/gui/resource/divinerIcons/right.png";
	private static final String IMAGE_LEFT = "/com/hacktics/diviner/gui/resource/divinerIcons/left.png";
	private static final String IMAGE_ADD = "/com/hacktics/diviner/gui/resource/divinerIcons/addPayload.png";
	private static final String IMAGE_Restore = "/com/hacktics/diviner/gui/resource/divinerIcons/restoreDefault.png";
	private static final String IMAGE_SAVE = "/com/hacktics/diviner/gui/resource/divinerIcons/save.png";
	private static final String IMAGE_LOAD = "/com/hacktics/diviner/gui/resource/divinerIcons/load.png";
